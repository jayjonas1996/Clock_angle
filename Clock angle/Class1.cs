...
namespace Clock_angle
{
    public class Clockangle
    {
        ...
        static public float Hands_angle_precise()
        {
            ...
            return Math.Abs((6f * mm) - ((30f * hh) + (.5f * mm))) > 180 ? (360 - Math.Abs((6f * mm) - ((30f * hh) + (.5f * mm)))) : Math.Abs((6f * mm) - ((30f * hh) + (.5f * mm)));                //returns acute angle between two hands, add 180 to the method output or remove code of c** to enable obtuce value;
        }
        ...
        /// <summary>
        ///Returns  angle between hour and minute hands of 
        ///the clock in  Degree and Decimals(DD) format, with hour hand angle being affected by minute hand.
        ///0 will be returned in case of empty DateTime object.
        /// </summary>
        /// <param name="dt"></param>
        /// <returns></returns>
        static public float Hands_angle_precise(DateTime dt)
        {
            short hh = (short)dt.Hour;
            short mm = (short)dt.Minute;
            if (hh >= 12)                                            //support for 24 hour format;
                hh -= 12;
        ...
        static public float Hands_angle()
        {
            ...
            return Math.Abs((6f * mm) - (30f * hh)) > 180 ? (360 - Math.Abs((6f * mm) - (30f * hh))) : Math.Abs((6f * mm) - (30f * hh));                 //returns acute angle between two hands, add 180 to the method output or remove code of c** to enable obtuce value;
        }
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        static public float Hands_angle(DateTime dt)
        {
